...
//初始化左侧,target是为了防止发生有一种情况，点击第二个时前一个被覆盖了
function InitLeftMenu() {
    ...
    $.each(_menus.menus, function(i, n) {
        ...
        $.each(n.menus, function(j, o) {
			menulist += '<li><div><a target="'+o.target+'" href="' + o.url + '" ><span class="icon '+o.icon+'" ></span>' + o.menuname + '</a></div></li> ';
        })
        menulist += '</ul></div>';
    })
	...
	$(".easyui-accordion").hide().show("slow").accordion();
